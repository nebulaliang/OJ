...
public class TwoSum {
    ...
    public int[] twoSum(int[] numbers, int target) {
        // define a hashmap to store the history number in numbers(key is
        // number,value is the index);
        // go through number(n) in numbers, check whether there is number in
        // hash x s.t. x = target - n;
