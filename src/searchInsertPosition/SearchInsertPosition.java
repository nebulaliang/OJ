...
public class SearchInsertPosition {
	 ...
	 * @param args
	 */
	//	Search Insert Position(leetcode 96)
	...
	//  Search a 2D Matrix(leetcode 92)
...
//        p(inserpos);
        if(inserpos!=n) {
        if(matrix[inserpos][0]==target) return true;}
        if(inserpos==0) return false;
	...
	//binary search. If found,return the index; otherwise, return the position it should insert.
	...
	public static void main(String[] args) {
		...
		int[][] A = new int[][]{{-8,-6,-5,-4,-2,-1,-1,0,2,4,5,7,7,7,7,9,9,9,9,11},
